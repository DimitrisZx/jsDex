type Payload = { key: string; data: any };
type AppState = { currentPokemon: { [key: string]: any }; [key: string]: any };
type updatePackage = { [key: string]: any };
type Subscriber = { [key: string]: any };
